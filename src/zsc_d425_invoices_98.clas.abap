...
CLASS zsc_d425_invoices_98 DEFINITION
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      "! <p class="shorttext synchronized" lang="en">Types for "OData Primitive Types"</p>
      BEGIN OF tys_types_for_prim_types,
        ...
        customer_name     TYPE c LENGTH 20,
        ...
        id                TYPE c LENGTH 10,
        "! Used for primitive type SAP_DESCRIPTION
        sap_description   TYPE c LENGTH 80,
      END OF tys_types_for_prim_types.

    TYPES:
      "! <p class="shorttext synchronized" lang="en">Parameters of function ZZ1_CUSTOMERINVOICE98Sap_upsert</p>
      ...
      "! <p class="shorttext synchronized" lang="en">List of TYS_PARAMETERS_1</p>
      tyt_parameters_1 TYPE STANDARD TABLE OF tys_parameters_1 WITH DEFAULT KEY.

    TYPES:
      "! <p class="shorttext synchronized" lang="en">I_CurrencyTextType</p>
      ...
      "! <p class="shorttext synchronized" lang="en">List of I_CurrencyTextType</p>
      tyt_i_currency_text_type TYPE STANDARD TABLE OF tys_i_currency_text_type WITH DEFAULT KEY.

    TYPES:
      "! <p class="shorttext synchronized" lang="en">I_CurrencyType</p>
      ...
      "! <p class="shorttext synchronized" lang="en">List of I_CurrencyType</p>
      tyt_i_currency_type TYPE STANDARD TABLE OF tys_i_currency_type WITH DEFAULT KEY.

    TYPES:
      "! <p class="shorttext synchronized" lang="en">I_LanguageType</p>
      ...
      "! <p class="shorttext synchronized" lang="en">List of I_LanguageType</p>
      tyt_i_language_type TYPE STANDARD TABLE OF tys_i_language_type WITH DEFAULT KEY.

    TYPES:
      "! <p class="shorttext synchronized" lang="en">P_Scbo_UserType</p>
      ...
      "! <p class="shorttext synchronized" lang="en">List of P_Scbo_UserType</p>
      tyt_p_scbo_user_type TYPE STANDARD TABLE OF tys_p_scbo_user_type WITH DEFAULT KEY.

    TYPES:
      "! <p class="shorttext synchronized" lang="en">ZZ1_CUSTOMERINVOICE98Type</p>
      ...
      "! <p class="shorttext synchronized" lang="en">List of ZZ1_CUSTOMERINVOICE98Type</p>
    ...
    CONSTANTS:
      "! <p class="shorttext synchronized" lang="en">Internal Names of the function imports</p>
    ...
    CONSTANTS:
      "! <p class="shorttext synchronized" lang="en">Internal Names of the bound functions</p>
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_type,
        "! <p class="shorttext synchronized" lang="en">Internal names for I_CurrencyTextType</p>
        ...
        "! <p class="shorttext synchronized" lang="en">Internal names for ZZ1_CUSTOMERINVOICE98Type</p>
  ...
  PRIVATE SECTION.
    ...
    "! <p class="shorttext synchronized" lang="en">Define I_CurrencyTextType</p>
    ...
    "! <p class="shorttext synchronized" lang="en">Define I_CurrencyType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized" lang="en">Gateway Exception</p>
    METHODS def_i_currency_type RAISING /iwbep/cx_gateway.

    "! <p class="shorttext synchronized" lang="en">Define I_LanguageType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized" lang="en">Gateway Exception</p>
    METHODS def_i_language_type RAISING /iwbep/cx_gateway.

    "! <p class="shorttext synchronized" lang="en">Define P_Scbo_UserType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized" lang="en">Gateway Exception</p>
    METHODS def_p_scbo_user_type RAISING /iwbep/cx_gateway.

    "! <p class="shorttext synchronized" lang="en">Define ZZ1_CUSTOMERINVOICE98Type</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized" lang="en">Gateway Exception</p>
    METHODS def_zz_1_customerinvoice_98_ty RAISING /iwbep/cx_gateway.

    "! <p class="shorttext synchronized" lang="en">Define ZZ1_CUSTOMERINVOICE98Sap_upsert</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized" lang="en">Gateway Exception</p>
    METHODS def_zz_1_customerinvoice_98_sa RAISING /iwbep/cx_gateway.

    "! <p class="shorttext synchronized" lang="en">Define all primitive types</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized" lang="en">Gateway Exception</p>
...
CLASS zsc_d425_invoices_98 IMPLEMENTATION.
  ...
  METHOD /iwbep/if_v4_mp_basic_pm~define.
    ...
    mo_model = io_model.
    mo_model->set_schema_namespace( 'ZZ1_CUSTOMERINVOICE98_CDS' ).
  ...
  METHOD def_zz_1_customerinvoice_98_ty.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'SAP_DESCRIPTION' ).
    lo_primitive_property->set_edm_name( 'SAP_Description' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 80 ).
    lo_primitive_property->set_scale_floating( ).
    lo_primitive_property->set_is_nullable( ).
  ...
  METHOD def_zz_1_customerinvoice_98_sa.
    ...
    lo_parameter = lo_function->create_parameter( 'SAP_DESCRIPTION' ).
    lo_parameter->set_edm_name( 'SAP_Description' ) ##NO_TEXT.
    lo_parameter->set_primitive_type( 'SAP_DESCRIPTION' ).
    lo_parameter->set_is_nullable( ).
  ...
  METHOD define_primitive_types.
    ...
    lo_primitive_type->set_precision( 16 ).
    lo_primitive_type->set_scale( 3 ).
    ...
    lo_primitive_type->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_type->set_precision( 5 ).
    ...
    lo_primitive_type = mo_model->create_primitive_type_by_elem(
                            iv_primitive_type_name = 'SAP_DESCRIPTION'
                            iv_element             = VALUE tys_types_for_prim_types-sap_description( ) ).
    lo_primitive_type->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_type->set_scale_variable( ).
